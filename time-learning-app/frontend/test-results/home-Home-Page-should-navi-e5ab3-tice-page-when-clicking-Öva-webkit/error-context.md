...
- Name: home.spec.ts >> Home Page >> should navigate to practice page when clicking Öva
- Location: tests/e2e/home.spec.ts:23:7

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'Öva' }) resolved to 2 elements:
    1) <a href="/practice" class="flex items-center space-x-1 px-4 py-2 rounded-lg transition-all duration-200 text-gray-600 hover:bg-gray-100 hover:text-gray-900">…</a> aka getByRole('link', { name: 'Öva', exact: true })
    2) <a href="/practice" class="block card hover:shadow-2xl transition-all duration-300 group">…</a> aka getByRole('link', { name: 'Öva Träna på olika' })

Call log:
  - waiting for getByRole('link', { name: 'Öva' })
...
- generic [ref=e3]:
  ...
  - main [ref=e30]:
    - generic [ref=e31]:
      ...
      - generic [ref=e35]:
        - link "Lär Lär dig känna igen klockan och förstå tid Börja nu" [ref=e37]:
          - /url: /learn
          - img [ref=e39]
          ...
          - generic [ref=e44]:
            - text: Börja nu
            - img [ref=e45]
        - link "Öva Träna på olika tidsuppgifter Börja nu" [ref=e48]:
          - /url: /practice
          - img [ref=e50]
          ...
          - generic [ref=e54]:
            - text: Börja nu
            - img [ref=e55]
        - link "Spela Lär dig med roliga spel och utmaningar Börja nu" [ref=e58]:
          - /url: /play
          - img [ref=e60]
