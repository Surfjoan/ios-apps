...
- Name: home.spec.ts >> Home Page >> should navigate to home when clicking logo
- Location: tests/e2e/home.spec.ts:51:7

# Error details

```
Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'Klockan' }) resolved to 2 elements:
    1) <a href="/" class="flex items-center space-x-2">…</a> aka getByRole('link', { name: 'Klockan', exact: true })
...
Call log:
  - waiting for getByRole('link', { name: 'Klockan' })
