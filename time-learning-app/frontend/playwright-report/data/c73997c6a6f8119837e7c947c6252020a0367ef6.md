...
- Name: home.spec.ts >> Home Page >> should display the home page correctly
- Location: tests/e2e/home.spec.ts:8:7
...
Locator: getByRole('link', { name: 'Lär' })
Expected: visible
Error: strict mode violation: getByRole('link', { name: 'Lär' }) resolved to 3 elements:
